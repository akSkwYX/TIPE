...
let check_nominal_group determiner adjective1 noun adjective2 =
  let determiner_noun = check_determiner_noun determiner noun in
  match determiner_noun with
  | [] -> []
  | [gender; noun] ->
    let adjective1_noun = check_adjective_noun adjective1 noun in
    match adjective1_noun with
    | [] -> []
    | [gender2; noun2] ->
      let result = check_gender gender gender2 @ check_number noun noun2 in (*TODO*)
